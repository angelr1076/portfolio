...
export default function Footer () {
  ...
  return (
    <div className="footer">
      ...
      <p>
        <FaReact className={`react-logo${theme === 'light' ? '-light' : '' }`} alt="React logo" title="This project was built using React" />
        <a href="https://www.onlinewebfonts.com/icon" target="_blank" rel="noopener noreferrer">
          <ImFontSize className={`font-logo${theme === 'light' ? '-light' : '' }`} title='Icons made from svg icons is licensed by CC BY 4.0' />
        </a> 
      </p>
    </div>
    )
